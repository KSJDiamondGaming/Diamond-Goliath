...
const moduleManifest = Object.freeze({
  ...
  invites: { key: 'invites', name: 'Invite Studio', maturity: MODULE_MATURITY.IN_PROGRESS, capabilities: createCapabilityMap({ guildStorage: true, runtime: true, adminPanel: true, api: true, health: true, startupRecovery: true, export: true, reset: true }) },
