...
const ACTION_REQUIREMENTS = {
  ...
  proceeding_manage: STAFF_LEVELS.MOD,
  proceeding_review: STAFF_LEVELS.ADMIN,
  proceeding_publish: STAFF_LEVELS.ADMIN,
  proceeding_close: STAFF_LEVELS.ADMIN,
  proceeding_delete: STAFF_LEVELS.ADMIN,
...
const ACTION_AUTHORITY_PERMISSIONS = Object.freeze({
  ...
  proceeding_manage: { key: 'mod.proceeding.manage', fallback: 'mod.cases.manage' },
  proceeding_review: { key: 'mod.proceeding.review', fallback: 'mod.cases.manage' },
  proceeding_publish: { key: 'mod.proceeding.publish', fallback: 'mod.cases.manage' },
  proceeding_close: { key: 'mod.proceeding.close', fallback: 'mod.cases.manage' },
  proceeding_delete: { key: 'mod.proceeding.delete' },
