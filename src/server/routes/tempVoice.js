...
function canonicalConfig(guildId, section = tempVoiceStore.getTempVoiceSection(guildId)) { return { ...section, enabled: isModuleEnabled(guildId, 'tempVoice') }; }
