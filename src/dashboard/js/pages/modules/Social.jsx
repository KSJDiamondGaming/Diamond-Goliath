...
function defaultOperations(settings = {}) {
  return { retryDeliveries: settings.retryDeliveries !== false, maxDeliveryAttempts: Number(settings.maxDeliveryAttempts || 5), suppressDuplicates: settings.suppressDuplicates !== false, editLiveNotifications: settings.editLiveNotifications === true, deleteEndedNotifications: settings.deleteEndedNotifications === true, includeViewerCount: settings.includeViewerCount !== false, includeLiveDuration: settings.includeLiveDuration !== false, thumbnailPreference: settings.thumbnailPreference || 'stream' };
}
