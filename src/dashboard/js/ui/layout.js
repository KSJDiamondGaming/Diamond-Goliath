...
const Forms = lazy(() => import('../pages/modules/feedbackStudio/forms/FormsWorkflowEnhanced'));
...
const Tickets = lazy(() => import('../pages/modules/feedbackStudio/tickets/TicketsWorkflowEnhanced'));
