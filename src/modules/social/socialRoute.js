...
router.get('/:guildId/creator-hub/diagnostics', (req, res) => {
...
router.get('/:guildId/creator-hub/diagnostics/providers', (req, res) => {
...
router.get('/:guildId/creator-hub/diagnostics/creators', (req, res) => {
...
router.get('/:guildId/creator-hub', (req, res) => {
  try {
...
router.post('/:guildId/creator-hub/rebuild', (req, res) => {
  try {
...
router.post('/:guildId/creator-hub', (req, res) => {
  try {
...
router.patch('/:guildId/creator-hub/:creatorId', (req, res) => {
  try {
...
router.delete('/:guildId/creator-hub/:creatorId', (req, res) => {
  try {
...
router.post('/:guildId/creator-hub/:creatorId/accounts/:accountId', (req, res) => {
  try {
...
router.delete('/:guildId/creator-hub/:creatorId/accounts/:accountId', (req, res) => {
  try {
...
router.post('/:guildId/creator-hub/accounts/:accountId/simulate', async (req, res) => {
  try {
