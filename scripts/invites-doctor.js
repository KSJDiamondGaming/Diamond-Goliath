...
for (const token of ['publicPanel', 'leaderboardPanel', 'messageId', 'inviteCode', 'Get My Invite', 'Delete My Invite', 'interaction.user.send', 'createPersonalInvite', 'deletePersonalInvite', 'queueLeaderboardRefresh', 'message.edit']) check(`Invite public panels ${token}`, publicPanels.includes(token));
